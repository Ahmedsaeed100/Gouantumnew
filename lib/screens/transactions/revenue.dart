...
class Revenue extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: transactionController.getRevenues(),
      builder: (context, snapshot) {
        if(!snapshot.hasData){
          ...
          List<String> dates = transactionController
              .getDates(transactionController.revenueCalls);
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    List<ModelRevenue> data =
                        transactionController.getListDataFromDate(
                            dates[index], transactionController.revenueCalls);
